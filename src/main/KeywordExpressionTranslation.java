...
//    {
//
//        main.ResultRow entry = (main.ResultRow) vistor.visit(ctx.primary());
//
...
//
//                resultBlock.append(new main.ResultRow("if(" + entry.getResult() + ")",true));
...
//                    {
//                        resultBlock.append(new main.ResultRow("else:",true));
